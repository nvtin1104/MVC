...
<head>
    ...
    <!-- FontAwesome JS-->
    <script defer src="<? echo _WEB_ROOT ?>/public/assets/admin/plugins/fontawesome/js/all.min.js"></script>

    <!-- App CSS -->
    <link id="theme-style" rel="stylesheet" href="<? echo _WEB_ROOT ?>/public/assets/admin/css/portal.css">
...
<body class="app">
                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="app-utilities col-auto">
                            ...
                            <div class="app-utility-item app-user-dropdown dropdown">
                                <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false"><img src="<? echo _WEB_ROOT ?>/public/assets/admin/images/user.png" alt="user profile"></a>
        ...
        <div id="app-sidepanel" class="app-sidepanel">
            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <div class="app-branding">
                    <a class="app-logo" href="index.html"><img class="logo-icon me-2" src="<? echo _WEB_ROOT ?>/public/assets/admin/images/app-logo.svg" alt="logo"><span class="logo-text">PORTAL</span></a>
                ...
                <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <a class="nav-link active" href="<?echo _WEB_ROOT?>/admin/dashboard">
                                <span class="nav-icon">
    ...
    <!-- Javascript -->
    <script src="<? echo _WEB_ROOT ?>/public/assets/admin/plugins/popper.min.js"></script>
    <script src="<? echo _WEB_ROOT ?>/public/assets/admin/plugins/bootstrap/js/bootstrap.min.js"></script>

    <!-- Charts JS -->
    <script src="<? echo _WEB_ROOT ?>/public/assets/admin/plugins/chart.js/chart.min.js"></script>
    <script src="<? echo _WEB_ROOT ?>/public/assets/admin/js/index-charts.js"></script>

    <!-- Page Specific JS -->
    <script src="<? echo _WEB_ROOT ?>/public/assets/admin/js/app.js"></script>
